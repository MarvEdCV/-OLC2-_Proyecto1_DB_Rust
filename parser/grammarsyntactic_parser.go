...
type GrammarSyntactic struct {
	*antlr.BaseParser
}

func NewGrammarSyntactic(input antlr.TokenStream) *GrammarSyntactic {
	this := new(GrammarSyntactic)
	...
	this.GrammarFileName = "GrammarSyntactic.g4"

	return this
}

// GrammarSyntactic tokens.
const (
	GrammarSyntacticEOF        = antlr.TokenEOF
	GrammarSyntacticCONSOLE    = 1
	GrammarSyntacticLOG        = 2
	GrammarSyntacticP_NUMBER   = 3
	GrammarSyntacticP_STRING   = 4
	GrammarSyntacticP_IF       = 5
	GrammarSyntacticP_WHILE    = 6
	GrammarSyntacticNUMBER     = 7
	GrammarSyntacticSTRING     = 8
	GrammarSyntacticID         = 9
	GrammarSyntacticPUNTO      = 10
	GrammarSyntacticPTCOMA     = 11
	GrammarSyntacticCOMA       = 12
	GrammarSyntacticDIFERENTE  = 13
	GrammarSyntacticIGUAL      = 14
	GrammarSyntacticMAYORIGUAL = 15
	GrammarSyntacticMENORIGUAL = 16
	GrammarSyntacticMAYOR      = 17
	GrammarSyntacticMENOR      = 18
	GrammarSyntacticMUL        = 19
	GrammarSyntacticDIV        = 20
	GrammarSyntacticADD        = 21
	GrammarSyntacticSUB        = 22
	GrammarSyntacticPARIZQ     = 23
	GrammarSyntacticPARDER     = 24
	GrammarSyntacticLLAVEIZQ   = 25
	GrammarSyntacticLLAVEDER   = 26
	GrammarSyntacticCORIZQ     = 27
	GrammarSyntacticCORDER     = 28
	GrammarSyntacticWHITESPACE = 29
)

// GrammarSyntactic rules.
const (
	GrammarSyntacticRULE_start         = 0
	GrammarSyntacticRULE_instrucciones = 1
	GrammarSyntacticRULE_instruccion   = 2
	GrammarSyntacticRULE_array_st      = 3
	GrammarSyntacticRULE_expression    = 4
	GrammarSyntacticRULE_expr_arit     = 5
	GrammarSyntacticRULE_listValues    = 6
	GrammarSyntacticRULE_primitivo     = 7
	GrammarSyntacticRULE_listArray     = 8
)
...
func NewEmptyStartContext() *StartContext {
	...
	p.RuleIndex = GrammarSyntacticRULE_start
	return p
}
...
func (s *StartContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(GrammarSyntacticListener); ok {
...
func (p *GrammarSyntactic) Start() (localctx IStartContext) {
	localctx = NewStartContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, GrammarSyntacticRULE_start)
...
func NewEmptyInstruccionesContext() *InstruccionesContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = GrammarSyntacticRULE_instrucciones
	return p
}
...
func (p *GrammarSyntactic) Instrucciones() (localctx IInstruccionesContext) {
	localctx = NewInstruccionesContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, GrammarSyntacticRULE_instrucciones)
	...
	for ((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<GrammarSyntacticCONSOLE)|(1<<GrammarSyntacticP_NUMBER)|(1<<GrammarSyntacticP_IF)|(1<<GrammarSyntacticP_WHILE)|(1<<GrammarSyntacticID))) != 0 {
		{
			p.SetState(21)
...
func NewEmptyInstruccionContext() *InstruccionContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = GrammarSyntacticRULE_instruccion
	return p
}
...
func (s *InstruccionContext) CONSOLE() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticCONSOLE, 0)
}

func (s *InstruccionContext) PUNTO() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticPUNTO, 0)
}

func (s *InstruccionContext) LOG() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticLOG, 0)
}

func (s *InstruccionContext) PARIZQ() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticPARIZQ, 0)
}
...
func (s *InstruccionContext) PARDER() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticPARDER, 0)
}

func (s *InstruccionContext) PTCOMA() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticPTCOMA, 0)
}

func (s *InstruccionContext) P_NUMBER() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticP_NUMBER, 0)
}

func (s *InstruccionContext) IGUAL() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticIGUAL, 0)
}
...
func (s *InstruccionContext) ID() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticID, 0)
}

func (s *InstruccionContext) P_IF() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticP_IF, 0)
}

func (s *InstruccionContext) LLAVEIZQ() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticLLAVEIZQ, 0)
}
...
func (s *InstruccionContext) LLAVEDER() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticLLAVEDER, 0)
}

func (s *InstruccionContext) P_WHILE() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticP_WHILE, 0)
}
...
func (p *GrammarSyntactic) Instruccion() (localctx IInstruccionContext) {
	localctx = NewInstruccionContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 4, GrammarSyntacticRULE_instruccion)
	...
	case GrammarSyntacticCONSOLE:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(29)
			p.Match(GrammarSyntacticCONSOLE)
		}
		{
			p.SetState(30)
			p.Match(GrammarSyntacticPUNTO)
		}
		{
			p.SetState(31)
			p.Match(GrammarSyntacticLOG)
		}
		{
			p.SetState(32)
			p.Match(GrammarSyntacticPARIZQ)
		}
		{
			p.SetState(33)
		...
		{
			p.SetState(34)
			p.Match(GrammarSyntacticPARDER)
		}
		{
			p.SetState(35)
			p.Match(GrammarSyntacticPTCOMA)
		}
		localctx.(*InstruccionContext).instr = instruction.NewImprimir(localctx.(*InstruccionContext).Get_expression().GetP())

	case GrammarSyntacticP_NUMBER:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(38)
			p.Match(GrammarSyntacticP_NUMBER)
		}
		{
			p.SetState(39)
		...
		}
		{
			...
			var _m = p.Match(GrammarSyntacticID)

			localctx.(*InstruccionContext).id = _m
		}
		{
			p.SetState(41)
			p.Match(GrammarSyntacticIGUAL)
		}
		{
			p.SetState(42)
	...
	case GrammarSyntacticP_IF:
		p.EnterOuterAlt(localctx, 4)
		{
			p.SetState(52)
			p.Match(GrammarSyntacticP_IF)
		}
		{
			p.SetState(53)
			p.Match(GrammarSyntacticPARIZQ)
		...
		{
			p.SetState(56)
			p.Match(GrammarSyntacticLLAVEIZQ)
		}
		{
			p.SetState(57)
		...
		{
			p.SetState(58)
			p.Match(GrammarSyntacticLLAVEDER)
		}
	...
	case GrammarSyntacticP_WHILE:
		p.EnterOuterAlt(localctx, 5)
		{
			p.SetState(61)
			p.Match(GrammarSyntacticP_WHILE)
		}
		{
			p.SetState(62)
			p.Match(GrammarSyntacticPARIZQ)
...
func NewEmptyArray_stContext() *Array_stContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = GrammarSyntacticRULE_array_st
	return p
}
...
func (s *Array_stContext) CORIZQ() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticCORIZQ, 0)
}

func (s *Array_stContext) CORDER() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticCORDER, 0)
}
...
func (p *GrammarSyntactic) Array_st() (localctx IArray_stContext) {
	localctx = NewArray_stContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 6, GrammarSyntacticRULE_array_st)
	...
	switch p.GetTokenStream().LA(1) {
	case GrammarSyntacticCORIZQ:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(72)
			p.Match(GrammarSyntacticCORIZQ)
		}
		{
			p.SetState(73)
			p.Match(GrammarSyntacticCORDER)
		}
...
func NewEmptyExpressionContext() *ExpressionContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = GrammarSyntacticRULE_expression
	return p
}
...
func (p *GrammarSyntactic) Expression() (localctx IExpressionContext) {
	localctx = NewExpressionContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 8, GrammarSyntacticRULE_expression)
...
func NewEmptyExpr_aritContext() *Expr_aritContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = GrammarSyntacticRULE_expr_arit
	return p
}
...
func (s *Expr_aritContext) MUL() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticMUL, 0)
}

func (s *Expr_aritContext) DIV() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticDIV, 0)
}

func (s *Expr_aritContext) ADD() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticADD, 0)
}

func (s *Expr_aritContext) SUB() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticSUB, 0)
}

func (s *Expr_aritContext) MENOR() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticMENOR, 0)
}

func (s *Expr_aritContext) MENORIGUAL() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticMENORIGUAL, 0)
}

func (s *Expr_aritContext) MAYORIGUAL() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticMAYORIGUAL, 0)
}

func (s *Expr_aritContext) MAYOR() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticMAYOR, 0)
}
...
func (p *GrammarSyntactic) Expr_arit() (localctx IExpr_aritContext) {
	return p.expr_arit(0)
}

func (p *GrammarSyntactic) expr_arit(_p int) (localctx IExpr_aritContext) {
	...
	_startState := 10
	p.EnterRecursionRule(localctx, 10, GrammarSyntacticRULE_expr_arit, _p)
	var _la int
	...
	case GrammarSyntacticNUMBER, GrammarSyntacticSTRING, GrammarSyntacticID:
		{
			p.SetState(87)
	...
	for _alt != 2 && _alt != antlr.ATNInvalidAltNumber {
		if _alt == 1 {
			...
			case 1:
				...
				p.PushNewRecursionContext(localctx, _startState, GrammarSyntacticRULE_expr_arit)
				p.SetState(97)
				...
				}
				{
					...
					if !(_la == GrammarSyntacticMUL || _la == GrammarSyntacticDIV) {
			...
			case 2:
				...
				}
				{
					...
					if !(_la == GrammarSyntacticADD || _la == GrammarSyntacticSUB) {
						var _ri = p.GetErrorHandler().RecoverInline(p)
			...
			case 3:
				...
				}
				{
					...
					if !(((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<GrammarSyntacticMAYORIGUAL)|(1<<GrammarSyntacticMENORIGUAL)|(1<<GrammarSyntacticMAYOR)|(1<<GrammarSyntacticMENOR))) != 0) {
						var _ri = p.GetErrorHandler().RecoverInline(p)
...
func NewEmptyListValuesContext() *ListValuesContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = GrammarSyntacticRULE_listValues
	return p
}
...
func (s *ListValuesContext) COMA() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticCOMA, 0)
}
...
func (p *GrammarSyntactic) ListValues() (localctx IListValuesContext) {
	return p.listValues(0)
}

func (p *GrammarSyntactic) listValues(_p int) (localctx IListValuesContext) {
	var _parentctx antlr.ParserRuleContext = p.GetParserRuleContext()
	_parentState := p.GetState()
	...
	var _ antlr.ParserRuleContext = _prevctx // TODO: To prevent unused variable warning.
	_startState := 12
	p.EnterRecursionRule(localctx, 12, GrammarSyntacticRULE_listValues, _p)
	...
	for _alt != 2 && _alt != antlr.ATNInvalidAltNumber {
		if _alt == 1 {
			...
			p.PushNewRecursionContext(localctx, _startState, GrammarSyntacticRULE_listValues)
			p.SetState(121)
...
func NewEmptyPrimitivoContext() *PrimitivoContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = GrammarSyntacticRULE_primitivo
	return p
}
...
func (s *PrimitivoContext) NUMBER() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticNUMBER, 0)
}

func (s *PrimitivoContext) STRING() antlr.TerminalNode {
	return s.GetToken(GrammarSyntacticSTRING, 0)
}
...
func (p *GrammarSyntactic) Primitivo() (localctx IPrimitivoContext) {
	localctx = NewPrimitivoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 14, GrammarSyntacticRULE_primitivo)
	...
	switch p.GetTokenStream().LA(1) {
	case GrammarSyntacticNUMBER:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(131)

			var _m = p.Match(GrammarSyntacticNUMBER)
	...
	case GrammarSyntacticSTRING:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(133)

			var _m = p.Match(GrammarSyntacticSTRING)
...
func NewEmptyListArrayContext() *ListArrayContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = GrammarSyntacticRULE_listArray
	return p
}
...
func (p *GrammarSyntactic) ListArray() (localctx IListArrayContext) {
	return p.listArray(0)
}

func (p *GrammarSyntactic) listArray(_p int) (localctx IListArrayContext) {
	var _parentctx antlr.ParserRuleContext = p.GetParserRuleContext()
	_parentState := p.GetState()
	...
	var _ antlr.ParserRuleContext = _prevctx // TODO: To prevent unused variable warning.
	_startState := 16
	p.EnterRecursionRule(localctx, 16, GrammarSyntacticRULE_listArray, _p)
	...
	for _alt != 2 && _alt != antlr.ATNInvalidAltNumber {
		if _alt == 1 {
			...
			p.PushNewRecursionContext(localctx, _startState, GrammarSyntacticRULE_listArray)
			p.SetState(144)
...
func (p *GrammarSyntactic) Sempred(localctx antlr.RuleContext, ruleIndex, predIndex int) bool {
	switch ruleIndex {
	case 5:
...
func (p *GrammarSyntactic) Expr_arit_Sempred(localctx antlr.RuleContext, predIndex int) bool {
	switch predIndex {
	case 0:
...
func (p *GrammarSyntactic) ListValues_Sempred(localctx antlr.RuleContext, predIndex int) bool {
	switch predIndex {
	case 3:
...
func (p *GrammarSyntactic) ListArray_Sempred(localctx antlr.RuleContext, predIndex int) bool {
	switch predIndex {
	case 4:
		return p.Precpred(p.GetParserRuleContext(), 2)
